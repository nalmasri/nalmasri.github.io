...
//       bottom: 'auto',
//       transform: isMobile
//         ? `translateY(calc(-50% + ${visible ? 0 : 16}px))`
//         : `translateY(-50%) translateX(${visible ? 0 : 16}px)`,
//       width: isMobile ? 'auto' : 248,
//       maxHeight: isMobile ? '80dvh' : 'calc(100vh - 80px)',
//       display: 'flex',
//       flexDirection: 'column',
//       background: '#fff',
//       border: '1.5px solid rgba(171,19,28,0.2)',
//       borderRadius: 16,
//       overflow: 'hidden',
//       boxShadow: '0 8px 40px rgba(171,19,28,0.1)',
//       opacity: visible ? 1 : 0,
...
//         {/* <span style={{
//           direction: 'rtl',
//           fontSize: isMobile ? 11 : 20, letterSpacing: isMobile ? 0.8 : 2, color: 'rgba(255,255,255,0.75)', fontFamily: 'Tajawal,sans-serif',
//           whiteSpace: 'nowrap',
...
//    <span style={{
//   direction: 'rtl',
//   fontWeight: 300,           // add this
//   fontSize: isMobile ? 10 : 20,      // was 9 : 11
//   letterSpacing: isMobile ? 1 : 2,   // was 0.8 : 1.5
//   color: 'rgba(255,255,255,0.95)',    // was 0.75
//   fontFamily: 'Tajawal, sans-serif',  // add space after comma
//   whiteSpace: 'nowrap',
//   maxWidth: isMobile ? '100%' : 'none',
//   overflow: 'hidden',
//   textOverflow: 'ellipsis',
