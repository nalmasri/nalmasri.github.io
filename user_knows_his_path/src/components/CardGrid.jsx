...
// const cards = Object.keys(PROGRAMS).map((program, index) => ({
//   program,
//   title: program,
//   description: PROGRAMS[program].jobs?.[0] || 'برنامج تدريبي',
...
const strokeMap = {
  /* MAIN RED */
  'ic-red': 'rgba(177, 18, 38, 0.42)',

  /* SOFT RED */
  'ic-blue': 'rgba(188, 52, 70, 0.40)',

  /* DARK BURGUNDY */
  'ic-green': 'rgba(122, 16, 32, 0.42)',

  /* LIGHT ROSE */
  'ic-orange': 'rgba(205, 88, 104, 0.38)',

  /* WINE */
  'ic-purple': 'rgba(143, 35, 50, 0.42)',

  /* FADED RED */
  'ic-cyan': 'rgba(214, 120, 132, 0.32)',

  /* PREMIUM RED */
  'ic-yellow': 'rgba(168, 28, 46, 0.40)',

  /* ROSE */
  'ic-pink': 'rgba(198, 78, 96, 0.42)',

  /* BURGUNDY */
  'ic-teal': 'rgba(132, 22, 38, 0.40)',

  /* DARK WINE */
  'ic-brown': 'rgba(92, 12, 24, 0.38)',
};
